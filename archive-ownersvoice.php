            ...
            <div class="bl_cont">
                <div class="bl_breadcrumb">
                    <ul class="bl_breadcrumb_list">
                        ...
                        <li class="bl_breadcrumb_item" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a
                                href="http://test05.j-cool.co.jp/harumigaoka-test/ownersvoice/"
                                itemprop="url">オーナーズボイス</a></li>
                    </ul>
                </div>
                <div class="bl_cont_head js_fadeIn">
                    <h2 class="bl_cont_head_ttl">百人百様<span class="hp_letterSpace">、</span>それぞれの<span class="hp_mdBlock"></span>「晴海ヶ丘」ライフ</h2>
                    <p class="bl_cont_head_txt">
                        「晴海ヶ丘」ではオーナー様それぞれにここでの暮らしを楽しんでおられます。ここを生活の拠点に海の定住ライフを満喫されている方、別荘として趣味のガーデニングや野菜作りを楽しむ方…。「晴海ヶ丘」での暮らしぶりをオーナーのみなさまにお伺いしました。下記ボタンをクリックするとライフスタイル別の情報が一覧できます。
                    </p>
                </div>
                <div class="bl_cont_body">
                    <div class="bl_cont_body_lowerContainer">
                        ...
                        <ul class="bl_grid js-tab-boxes">
                            <?php query_posts( array( 'post_type' => 'ownersvoice','posts_per_page' => 100,'paged' => get_query_var('paged') ) ); ?>
                            <?php if (have_posts()) : ?>
