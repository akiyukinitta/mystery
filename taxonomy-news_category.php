            ...
            <div class="bl_cont">
                <div class="bl_breadcrumb">
                    <ul class="bl_breadcrumb_list">
                        ...
                        <li class="bl_breadcrumb_item" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a
                        href="#" itemprop="url"><?php the_terms($post->ID, 'news_category'); ?></a></li>
                    </ul>
                </div>
                <div class="bl_cont_head js_fadeIn">
                    <h2 class="bl_cont_head_ttl"><?php the_terms($post->ID, 'news_category'); ?></h2>
                </div>
                                ...
                                <div class="un_news">
                                    <div class="el_imgWrapper">
                                        <a href="<?php the_permalink(); ?>">
                                            ...
                                            <?php else: ?>
                                            <img src="<?php echo get_template_directory_uri(); ?>/images/common/no-image.jpg"
                                                alt="">
                                            <?php endif; ?>
                                        </a>
                                        <span
                                            class="bl_grid_item_category"><?php the_terms($post->ID, 'news_category'); ?></span>
                                    </div>
                                </div>
